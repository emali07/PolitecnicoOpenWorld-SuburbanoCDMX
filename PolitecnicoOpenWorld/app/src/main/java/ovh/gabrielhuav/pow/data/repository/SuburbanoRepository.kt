...
object SuburbanoRepository {
    ...
    fun loadStations(context: Context): List<SuburbanoStation> {
        return listOf(
            ...
            SuburbanoStation("Lechería", listOf("Suburbano"), GeoPoint(19.6087, -99.1811)),
            SuburbanoStation("Tultitlán", listOf("Suburbano"), GeoPoint(19.6465, -99.1688)),
            SuburbanoStation("Cuautitlán", listOf("Suburbano"), GeoPoint(19.6728, -99.1804))
        )
    }
}